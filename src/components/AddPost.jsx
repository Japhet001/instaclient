  ...
  return (
    <div className="b__add-ideas">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input type="text" placeholder="Add Your title " {...register("idea_title", {required: "Add title to your post"})} id="" />
        <span className="error">{errors?.idea_title?.message}</span>
          <textarea
            ...
            id="idea"
            placeholder="Click down here to upload and share your post with other users"
          ></textarea>
